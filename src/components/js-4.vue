...
<template>
  ...
  <h2>访问对象的属性</h2>
  <p>访问对象属性的语法是：</p>
  <n-code language="js" :code="`objectName.propertyName`"></n-code>
  <h2>访问对象的方法</h2>
  <p>方法是能够在对象上执行的动作，可以通过以下语法来调用方法：</p>
  <n-code language="js" :code="`objectName.methodName()`"></n-code>
  <h2>创建 JavaScript 对象</h2>
  <h3>使用 Object </h3>
  <n-code language="js" :code="`// 以构造函数形式来调用
new Object([value])`"></n-code>
  <p>以下是创建对象的例子：</p>
  <n-code language="js" :code='`person=new Object();
person.firstname="John";
person.lastname="Doe";
person.age=50;
person.eyecolor="blue";`'></n-code>
  <h3>使用对象字面量</h3>
